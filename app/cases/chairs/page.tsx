...
const metrics = [
  { value: "Топ-5", label: "позиция в категории" },
  { value: "3 мес", label: "до топ-5" },
  ...
  return (
    ...
    >
      ...
      <main className="chairs-hero-main" style={{ padding: "clamp(40px, 8vh, 100px) clamp(20px, 5vw, 80px)", maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          Запуск нового бренда игровых кресел на Ozon с нуля — выход в топ-5 категории за 3 месяца без начальных отзывов и истории продаж.
        </p>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ marginBottom: "clamp(40px, 7vh, 80px)" }}>
          ...
          <p style={{ fontSize: "clamp(15px, 1.3vw, 18px)", color: "rgba(255,255,255,0.8)", lineHeight: 1.8, maxWidth: 800 }}>
            За 3 месяца с нуля удалось вывести бренд в топ-5 категории «Игровые кресла» на Ozon. Накоплено более 150 отзывов со средним рейтингом 4.8. Ежемесячная выручка достигла 1.8 млн ₽. Рекламный бюджет снизился на 35% при сохранении объёмов продаж за счёт роста органических позиций.
          </p>
        </div>
