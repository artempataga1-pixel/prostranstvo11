...
function ServicesAuditSection() {
  ...
  return (
    ...
    >
      ...
      >
        {"Проводим глубокий разбор кабинета и\u00A0находим точки, которые тормозят рост продаж и\u00A0прибыли. Анализируем карточки, рекламу, ассортимент, цены, воронку, остатки, отзывы и\u00A0общую логику управления. На выходе формируем понятный список узких мест и\u00A0конкретный план, что исправлять в\u00A0первую очередь."}
      </p>
  ...
  return (
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            >
              {"Три перспективных товара с\u00A0анализом спроса, конкуренции, рисков, экономической модели и\u00A0потенциальной прибыли — конкретные варианты для\u00A0закупки и\u00A0запуска."}
            </p>
          </div>
    ...
    <div className="podbor-mobile-screenshot-block" style={{ display: "none", backgroundColor: "#0f050e", padding: "16px 16px 32px", position: "relative" }}>
      ...
      <img
        ...
        loading="eager"
        style={{ width: "100%", height: "auto", borderRadius: 16, display: "block", position: "relative", zIndex: 1 }}
      />
      {/* Gradient — bottom: fade to ServicesAuditSection bg */}
      <div aria-hidden="true" style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: 80, background: "linear-gradient(to bottom, rgba(13,31,31,0) 0%, rgb(13,31,31) 100%)", zIndex: 2, pointerEvents: "none" }} />
    </div>
  </>
  );
}
  ...
  return (
    <section className="split-section team-section" style={{
      ...
      <p className="team-description" style={{
        ...
        {"Помогаем собрать сильную команду под задачи бизнеса: определяем, какие сотрудники действительно нужны, формируем портрет должности, выстраиваем систему подбора и\u00A0адаптации. Это\u00A0снижает риск найма \u201Cне тех\u201D людей и\u00A0помогает быстрее усиливать бизнес нужными специалистами."}
      </p>
