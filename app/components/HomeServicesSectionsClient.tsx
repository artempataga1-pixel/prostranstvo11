  ...
  return (
    <section className="split-section team-section" style={{
      ...
      <p className="team-description" style={{
        ...
        {"Помогаем собрать сильную команду под задачи бизнеса: определяем, какие сотрудники действительно нужны, формируем портрет должности, выстраиваем систему подбора и\u00A0адаптации. Это снижает риск найма "}
        <br />
        {"\u201Cне тех\u201D людей и\u00A0помогает быстрее усиливать бизнес нужными специалистами."}
      </p>
